...
/**
 * Created by Vijay on 3/15/2016.
 */
public class SectionedOrderRecieptAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private OrderRecieptActivity activity;

    public SectionedOrderRecieptAdapter(Context context, int sectionResourceId, int textResourceId,
                                        RecyclerView.Adapter baseAdapter, OrderRecieptActivity activity) {

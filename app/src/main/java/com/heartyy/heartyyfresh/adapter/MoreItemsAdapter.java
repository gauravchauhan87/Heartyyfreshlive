...
/**
 * Created by Dheeraj on 1/12/2016.
 */
public class MoreItemsAdapter extends RecyclerView.Adapter<MoreItemsAdapter.SimpleViewHolder> {
    ...
    public MoreItemsAdapter(Context context, ItemDetailActivity activity, List<SimilarItems> similarItemsList) {
        mContext = context;
    ...
    public void onBindViewHolder(final SimpleViewHolder holder, int position) {
        ...
        holder.discountedPrice.setTypeface(robotoLight);

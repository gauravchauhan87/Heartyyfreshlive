...
/**
 * Created by Vijay on 8/10/2016.
 */
public class SimilarItemListBaseAdapter extends BaseAdapter {
    Context context;
    ...
    public SimilarItemListBaseAdapter(Context context, ItemDetailActivity activity, List<SimilarItems> similarItemsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        discountedPrice.setTypeface(regular);
        ...
        if (temp.length > 1) {
            ...
            price.setText(Html.fromHtml("<sup> &nbsp; $</sup><big>" + temp[0] + "</big><sup>" + "0" + "</sup>"));
        }
